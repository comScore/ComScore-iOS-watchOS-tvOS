 ...
 *
 * @param expectedTotalLength - Expected total playback session length
 */
 ...
 *
 * @param expectedNumberOfItems - Expected total number of assets in playback session
 */
 ...
 *
 * @param loadTimeOffset - Load time offset.
 */
